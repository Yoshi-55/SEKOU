...
ActiveRecord::Schema[7.1].define(version: 20_260_302_031_243) do
  ...
  create_table 'applies', force: :cascade do |t|
    ...
    t.index %w[job_id craftsman_id], name: 'index_applies_on_job_id_and_craftsman_id', unique: true
